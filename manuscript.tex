...
In contrast, there is little previous work on guidance of flapping wing MAVs. Baek demonstrated 
altitude control with an external camera\cite{baek:altitude}. de Croon et al. demonstrated obstacle 
avoidance with an onboard camera and offboard processing\cite{delfly:avoid}. [However, these papers 
do not study the system blah blah blah.]
