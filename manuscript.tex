...
%----------------------------------------------------------------------------%
% METADATA
\def \papertitle{Cooperative Control and Modeling for Narrow Passage Traversal}
...
vehicles and purely analytical explorations. Hyams et al., Jung et al. and Nebot et al. all 
...
according to a PID control law. We apply a fixed-lag window to the PID 
...
output is the physical heading angle, $\theta(s)$. To model the translational position of
