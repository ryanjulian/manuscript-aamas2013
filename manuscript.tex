...
edges of the image frame of the camera. We started each trial with an initial
heading perpendicular to the window plane. The results of the experiments are
shown in Figures~\ref{fig:flight_paths} and~\ref{fig:flight_paths_feasible}.
...
feasible region (Figure~\ref{flight_paths}), the success rate diminishes
...
often over- or under-compensates in certain regions, depending on the PID
tuning and the distance from the camera.
