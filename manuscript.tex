...
%----------------------------------------------------------------------------%
% METADATA
\def \papertitle{Cooperative Control and Modeling for Narrow Passage Traversal with an Ornithopter MAV and Lightweight Ground Station}
...
requirements appropriate for deployment on ground vehicles with 10 gram 
...
\label{fig:h2bird}
\end{figure}
Power, size, and weight constraints on 10 gram scale micro air vehicles (MAVs) 
...
Although they demonstrate safety and noise profiles superior to those of 
...
use these systems to cooperatively navigate through a narrow passage, by
...
computer vision libraries for image capture and processing. All software and 
hardware we developed for this system is open source and freely available under 
a BSD license\footnote{\raggedright Biomimetic Millisystems Laboratory on GitHub, \href{https://github.com/biomimetics}{https://github.com/biomimetics}}.
...
system capabilities, and composing it with known system interactions. 

\noindent The corroboration between our simulated and experimental results shows that our
